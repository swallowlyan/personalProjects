      ...
      <div class="checkout-addr">
          ...
          <div class="addr-list">
            <ul>
              <li v-for="(address,index) in filterAddress" :key="index" :class="{'check':index==currentIndex}" @click="currentIndex=index">
                ...
                <!-- <dl v-show="!editAddress">
                  <dt><input type="text" :value="address.userName"></dt>
                  <dd class="address"><input type="text" :value="address.tel"></dd>
                  <dd class="tel"><input type="text" :value="address.userName"></dd>
                </dl> -->
                ...
                <div class="addr-opration addr-del">
                  <a href="javascript:;" class="addr-del-btn" @click="delAddress(address)">
                    <svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg>
                  </a>
                </div>
                <div class="addr-opration addr-set-default" v-if="!address.isDefault">
                  <a href="javascript:;" class="addr-set-default-btn"  @click="setDefault(address)"><i>设为默认</i></a>
                </div>
        ...
        <div class="shipping-method-wrap">
          <div class="shipping-method">
            <ul>
              <li :class="{'check':shippingCheck==1}" @click="shippingCheck=1">
                <div class="name">标准配送</div>
                <div class="price">Free</div>
              </li>
              <li :class="{'check':shippingCheck==2}" @click="shippingCheck=2">
...
<script>
   ...
   export default {
       ...
       methods: {
           ...
           delAddress(item){
             this.addressList = this.addressList.filter((val)=>{
               return val!=item;
             })
           }
       }
